...
/**
  ...
  * This is an event sourced entity. It has a state, [[KnolState]], which
  ...
  */
class KnolEntity extends PersistentEntity {

  override type Command = KnolCommand[_]
  override type Event = KnolEvent
  override type State = KnolState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: KnolState = KnolState("Hello", LocalDateTime.now.toString)
